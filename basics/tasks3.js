...
var getPromotionMessage = function (promotion) {
    switch (promotion.scope) {
        ...
        case 'account':
            return "This account has a discount. Only valid with this listing ID: ".concat(promotion.accountId);
    }
};
var calculateDiscount = function (promotion) {
    ...
    var price = promotion.listingPrice;
    switch (promotion.type) {
        case 'flat':
            return price - promotion.amount;
        case 'percentage':
            return price - (price * promotion.amount);
    }
    return price;
};
